...
# Calcular la tabla de frecuencias utilizando numpy.histogram
hist, bin_edges = np.histogram(data, bins=np.arange(rango_inicial, rango_final + ancho_rango, ancho_rango))
...
for i in range(len(hist)):
    ...
    print(f"{range_start}-{range_end}\t\t\t{hist[i]}")
